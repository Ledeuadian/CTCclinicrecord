{{-- Patient Health Records Partial for Shell --}}
<div class="bg-white shadow-sm rounded-lg">
    ...
    <div class="p-6">
        @php
            $totalRecords = ($healthRecords ? $healthRecords->count() : 0) + ($dentalExaminations ? $dentalExaminations->count() : 0) +
                           ($physicalExaminations ? $physicalExaminations->count() : 0) + ($immunizationRecords ? $immunizationRecords->count() : 0) +
                           ($prescriptionRecords ? $prescriptionRecords->count() : 0);
        @endphp
        ...
        @if($totalRecords > 0)
            ...
            <div class="space-y-6" id="recordsContainer">
                <!-- Dental Examinations -->
        ...
        @else
            <div class="text-center py-12">
                <div class="bg-gray-50 p-8 rounded-lg">
                    ...
                    <a href="#"
                       onclick="switchTab('appointments'); return false;"
