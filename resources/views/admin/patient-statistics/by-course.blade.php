...
<div class="mb-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Patients in {{ $course->course_name }}</h2>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th class="px-6 py-3">Educational Level</th>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-6 py-4">{{ $patient->educationalLevel->level_name ?? 'N/A' }}</td>
                        <td class="px-6 py-4">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 text-center">
        <p class="text-gray-500 dark:text-gray-400">No patients found in this course.</p>
    </div>
    @endif
</div>
@endsection
