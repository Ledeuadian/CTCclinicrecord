...
<div class="p-6">
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <h1 class="text-2xl font-bold text-gray-800">Patients in {{ $level->level_name }}</h1>
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">{{ $patient->course->course_name ?? 'N/A' }}</td>
                </tr>
                @empty
                <tr>
                    <td colspan="5" class="px-4 py-3 text-center text-gray-500">No patients found in this educational level.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
