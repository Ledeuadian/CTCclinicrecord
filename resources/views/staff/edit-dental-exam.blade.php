    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded">
            <div class="flex items-center">
                ...
                <p class="text-blue-700 font-medium">Staff Mode - Editing Dental Examination</p>
            </div>
        </div>
        ...
        <div class="bg-white shadow-sm rounded-lg">
            <form action="{{ route('staff.dental-exams.update', $exam->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6 bg-gray-50 p-4 rounded-lg">
                    <p class="text-sm text-gray-600">
                        <strong>Patient:</strong> {{ optional($exam->patient->user)->name ?? 'N/A' }}
                        <span class="ml-4"><strong>Patient ID:</strong> {{ $exam->patient_id }}</span>
                        <span class="ml-4"><strong>Exam ID:</strong> {{ $exam->id }}</span>
                    </p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    @php
                        ...
                        if (!$teethStatus || !is_array($teethStatus)) {
                            $teethStatus = [];
                            for ($i = 1; $i <= 32; $i++) {
