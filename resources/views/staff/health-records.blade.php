    ...
    <div class="bg-white shadow-sm rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('staff.health-records.create') }}"
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="flex justify-between items-start mb-4">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            @if($type === 'health')
                                                <a href="{{ route('staff.health-records.edit', $record->id) }}"
                                                   class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition">
                                                    Edit
                                                </a>
                                            @elseif($type === 'physical')
                                                <a href="{{ route('staff.physical-exams.edit', $record->id) }}"
                                                   class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md text-sm font-medium transition">
                                                    Edit
                                                </a>
                                            @elseif($type === 'dental')
                                                <a href="{{ route('staff.dental-exams.edit', $record->id) }}"
                                    ...
                                    @elseif($type === 'dental')
                                        ...
                                        @if($record->teeth_status)
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <!-- Legend -->
                                                <div class="flex flex-wrap gap-3 mb-3 p-3 bg-white rounded border">
                                                    <div class="flex items-center"><span class="w-4 h-4 bg-green-500 rounded mr-1"></span><span class="text-xs">Healthy</span></div>
                                                    <div class="flex items-center"><span class="w-4 h-4 bg-red-500 rounded mr-1"></span><span class="text-xs">Cavity</span></div>
                                                    <div class="flex items-center"><span class="w-4 h-4 bg-blue-500 rounded mr-1"></span><span class="text-xs">Filled</span></div>
                                                    <div class="flex items-center"><span class="w-4 h-4 bg-gray-400 rounded mr-1"></span><span class="text-xs">Missing</span></div>
                                                    <div class="flex items-center"><span class="w-4 h-4 bg-yellow-500 rounded mr-1"></span><span class="text-xs">Other</span></div>
                                                </div>

                                                <!-- Upper Teeth -->
                                                <div class="mb-4">
                                                    <p class="text-xs font-semibold text-gray-600 mb-2">Upper Teeth (1-16)</p>
                                                    <div class="grid grid-cols-8 gap-2 p-3 bg-purple-50 rounded-lg border border-purple-200">
                                                        @for($i = 1; $i <= 16; $i++)
                                                            ...
                                                            <div class="text-center">
                                                                <div class="w-10 h-10 {{ $bgColor }} rounded flex items-center justify-center text-white text-xs font-bold border-2 border-gray-300">
                                                                    {{ $i }}
                                                                </div>
                                                            </div>
                                                        @endfor
                                                ...
                                                <!-- Lower Teeth -->
                                                <div>
                                                    <p class="text-xs font-semibold text-gray-600 mb-2">Lower Teeth (17-32)</p>
                                                    <div class="grid grid-cols-8 gap-2 p-3 bg-purple-50 rounded-lg border border-purple-200">
                                                        @for($i = 17; $i <= 32; $i++)
                                                            @php
                                                                $status = $teethArray[$i] ?? 'healthy';
                                    ...
                                    <div class="mt-4 pt-4 border-t border-gray-200 flex space-x-3">
                                        <a href="{{ route('staff.patient-details', $patient->id) }}"
