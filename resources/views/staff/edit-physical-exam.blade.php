    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded">
            <div class="flex items-center">
                ...
                <p class="text-blue-700 font-medium">Staff Mode - Editing Physical Examination</p>
            </div>
        </div>
        ...
        <div class="bg-white shadow-sm rounded-lg">
            <form action="{{ route('staff.physical-exams.update', $exam->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
