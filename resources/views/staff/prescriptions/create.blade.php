...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
            <a href="{{ route('staff.prescriptions') }}" class="text-blue-600 hover:text-blue-800 mb-4 inline-flex items-center">
        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <form action="{{ route('staff.prescription.store') }}" method="POST">
                @csrf
