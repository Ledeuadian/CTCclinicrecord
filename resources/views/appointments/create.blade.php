<div id="appointmentModal" class="fixed inset-0 flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-lg p-6">
        ...
        <form action="{{ route('appointments.store') }}" method="POST" class="mt-4">
            @csrf
            <div class="mb-4">
                <label for="patient" class="block text-sm font-medium text-gray-700">Patient Name</label>
                <input type="text" name="patient_id" id="patient" required
            ...
            <div class="mb-4">
                ...
                <input type="text" name="doc_id" id="doctor" required
                       class="mt-1 p-2 w-full border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
